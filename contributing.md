...
```shell
git clone git@github.com:ton-community/tlb-parser.git
cd tlb-parser
...
Go [here](https://github.com/ton-community/tlb-parser/fork) to make a fork, then setup your remote:
...
Then create a pull request from the [pull requests page](https://github.com/ton-community/tlb-parser/pulls) or directly:

```shell
https://github.com/ton-community/tlb-parser/pull/new/name-of-your-feature
```
